...
@pytest.mark.parametrize("input_text, expected", [
    ...
    ("123", "سەد و بیست و سێ"),
    ("12.5", "دوازدە و نیو"),
    ("0.005", "سفر پۆینت سفر سفر پێنج"),
    ("-50", "سالب پەنجا"),
    ("+20", "موجەب بیست"),
    # Scientific Notation Thresholds
    ("0.00000000000000000000004", "چوار جارانی دە توانی سالب بیست و سێ"),
    ("34000000000000000000000", "سێ پۆینت چوار جارانی دە توانی بیست و دوو"),
    ("5.2e-10", "پێنج پۆینت دوو جارانی دە توانی سالب دە"),
    # Leading Zeros
    ("0025", "سفر سفر بیست و پێنج"),
    ("000007", "پێنج جار سفر حەوت"),
...
@pytest.mark.parametrize("input_text, expected", [
    ...
    ("I am m", "ئای ئام ئێم"),
    ("5mm", "پێنج میلیمەتر"),
    ("5mm gun", "پێنج میلیمەتر گەن"),
    # Half Rule Logic
    ("4.5 مریشک", "چوار مریشک و نیو"),
    ("1.5 مریشکەکانم", "یەک مریشک و نیوەکانم"),
    ("2.5 زۆربوون", "دوو و نیو زۆربوون"),
    # Per Rule
...
@pytest.mark.parametrize("input_text, expected", [
    ...
    ("+9647701234567", "کۆ نۆ سەد و شەست و چوار حەوت سەد و حەفتا سەد و بیست و سێ چل و پێنج شەست و حەوت"),
    ("2025/12/03", "سێی کانونی یەکەمی ساڵی دوو ھەزار و بیست و پێنج"),
...
@pytest.mark.parametrize("input_text, expected", [
    ("Hello World", "ھێلۆ وەڕلد"),
    ("ChatGPT", "چات جی پی تی"),
    ("Straẞe", "ستڕاسسێ"),
    ("République française", "ڕێپوبلیکوێ فڕانسایسێ"),
    ("Χαίρετε", "چایڕێتێ"),
    ("Путин", "پوتین"),
    ("北京市", "بێی جینگ شی"),
    ("Êvar baş", "ئێڤاڕ باش"),
...
@pytest.mark.parametrize("input_text, expected", [
    ("بِسْمِ ٱللَّهِ ٱلرَّحْمَـٰنِ ٱلرَّحِيمِ", "بیسمی للاھی ڕڕەحمانی ڕڕەحیمی"),
    ("ٱلْحَمْدُ لِلَّهِ", "ئەلحەمدو لیللاھی"),
    ("عَبدُاللّٰه", "عەبدوڵڵاھ"),
    ("مِرْصَاد", "میڕصاد"),
    ("مِنْ بَعْد", "مین بەعد"),
...
# --- 7. Technical & Web ---
@pytest.mark.parametrize("input_text, expected", [
    ("info@gmail.com", "ئینفۆ ئەت جیمەیڵ دۆت کۆم"),
    ("xwshm@êxamplé.com", "ئێکس دەبڵیو ئێس ئێچ ئێم ئەت ئی ئێکس ئەی ئێم پی ئێڵ ئی دۆت کۆم"),
    ("https://www.rudaw.net/sorani?id=123", "ئێچ تی تی پی ئێس دوو خاڵ سلاش سلاش دەبڵیو دەبڵیو دەبڵیو دۆت ئاڕ یو دی ئەی دەبڵیو دۆت نێت سلاش ئێس ئۆ ئاڕ ئەی ئێن ئای نیشانەی پرسیار ئای دی یەکسانە یەک دوو سێ"),
    ("123e4567-e89b-12d3", "یەک دوو سێ ئی چوار پێنج شەش حەوت داش ئی ھەشت نۆ بی داش یەک دوو دی سێ"),
...
def test_emoji_convert():
    ...
    pipe = Pipeline(config)
    assert pipe.normalize("سڵاو 😂 دڵم ❤️") == "سڵاو ئیمۆجییەکی پێکەنین و فرمێسک دڵم ئیمۆجییەکی دڵی سوور"

def test_emoji_remove():
    config = NormalizationConfig(emoji_mode="remove")
    pipe = Pipeline(config)
    assert pipe.normalize("سڵاو 😂 دڵم ❤️") == "سڵاو دڵم"
